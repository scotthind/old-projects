...
/**
 * A <code>LittleEndianInputStream</code> reads two's complement, little endian 
 * integers, floating point numbers, and characters and returns them as Java 
 * primitive types. The standard Java input stream classes read big-endian 
 * quantities.
 *
...
public class LittleEndianInputStream extends FilterInputStream {
    ...
    /**
     * Reads an ASCII string of a given length.
