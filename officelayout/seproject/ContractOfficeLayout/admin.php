...
<body onload="init()">
	<div id="maincontainer">
		<div id="logo">
			<a href="admin.php"><img src="../../MSEOfficeLayout/img/missionSolutionsEngineering_Logo.png" /></a>
		</div>
		...
		<div id="rightcolumn"><div class="innertube">
			<div id="search_box">
				...
				<a href="settings.php" id="settings" title="Click here to change administrative settings." 
			...
			<div id="editField" style="display:none; height:600px; width:150px;">
				<div id="personEdit" style="display:none;">
					...
					<button id="sureButtonEditPerson" style="display:none;" 
						value="editPerson" onclick="edit(true, this)">Yes</button>
				</div>
				<div id="utilityEdit"  style="display:none;">
					...
					<button id="sureButtonEditUtility" style="display:none;" 
						value="editUtility" onclick="edit(true, this)">Yes</button>
				</div>
				<br/>
			...
			<div id="removeField" style="display:none; height:600px; width:150px;">
				<div id="removePerson" style="display:none;">
					...
					<button id="sureButtonRemovePerson" style="display:none;" 
						value="removePerson" onclick="remove(true, this)">Yes</button>
				</div>
				<div id="utilityRemove"  style="display:none;">
					...
					<button id="sureButtonRemoveUtility" style="display:none;" 
						value="removeUtility" onclick="remove(true, this)">Yes</button>
				</div>
				<br/>
				<p id="removeFeature_response"></p>
			</div>
			<div id="addDepartment" style="display:none; height:600px; width:150px;">
				Department's name: <input type="text" onkeypress="return alpha(event, alphanumeral)" 
					id="newDeptName"/>
				<br/>
				<hr/>
				Select the Icon Color: <select id="iconDropdown"> </select>
				<br/><hr/>
				<button value="Add New Department" onclick="addNewDepartment()">Add Department</button>
			...
			<div id="removeDepartment" style="display:none; height:600px; width:150px;">
				...
				<button id="sureButton" style="display:none;" 
					value="yes" onclick="removeDepartment(true)">Yes</button>
			</div>
			<div id="insertNew" style="display:none; height:600px; width:150px;">
				...
				<div id="employeeInsert">
					...
					Cube Number: <input type="text"  onkeypress="return alpha(event, alphanumeral)"  
						id="newCubeNumber"/>
				...
				<br/><br/>
				<button value="Insert New Object" onclick="insert()">Submit</button>
				<br/><br/>
			...
			<div id="removeFeature" style="display:none; height:600px; width:150px;">
				...
				<p id="update_response"></p>
				<button id="sureRemoveButton" style="display:none;" 
					value="yes" onclick="removeFeature(true)">Yes</button>
			</div>
		</div>
		<div id="levelFoot">
